...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Forms are sent via unique token links — each recipient gets their own link that expires after 30 days and can only be submitted once. Go to the form\'s Submissions tab and use "Send invitations" to generate and email links.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'h3', text: 'Creating a template from scratch' },
      { type: 'steps', items: [
        'Go to Forms → Templates.',
        'Click "New template."',
        'Build the form structure exactly as you would a regular form.',
  ...
  },
  {
    ...
    content: [
      { type: 'p', text: 'Reports are free-form written documents that live alongside your data. They\'re where you write your narrative — program summaries, grant reports, impact stories — supported by an AI section generator that pulls from your actual submissions.' },
      ...
      { type: 'p', text: 'The right-hand panel is your AI assistant. Select a date range (or reporting period), choose which forms to include, pick a section type, and click "Insert AI section." The AI reads your actual submission data and writes a draft section directly into the editor.' },
      { type: 'list', items: [
      ...
      { type: 'tip', text: 'The AI generator uses Award Context documents (Logic Models, Continuation Docs, etc.) to ground its analysis in your program\'s stated goals. Add those under Settings → Award Context.' },
    ],
  },
  {
    id: 'impact',
  ...
  },
  {
    ...
    content: [
      { type: 'p', text: 'Evaluation Sidekick is a chat interface that lets you ask natural language questions about your program data. Ask about trends, comparisons, outliers — anything — and it responds based on your actual submissions.' },
      ...
      { type: 'p', text: 'Every time you ask a question, it loads all submitted data for your current program — forms, fields, responses — and uses that as context. Numeric fields are pre-aggregated by month so trend questions work well.' },
      { type: 'list', items: [
